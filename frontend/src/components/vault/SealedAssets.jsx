    ...
    <div className="space-y-6">
      ...
      <Card className="border">
        <CardHeader>
          <div className="flex items-start justify-between">
            <div>
              ...
              <CardTitle className="text-xl mb-2">{mockCredentials[0].issuer} - {mockCredentials[0].claims.program}</CardTitle>
              <p className="text-sm text-muted-foreground">Issued: {mockCredentials[0].issuedDate}</p>
            </div>
        ...
        <CardContent>
          <div className="flex gap-3">
            <Button
              onClick={() => setSelectedCredential(mockCredentials[0])}
              variant="outline"
              className="flex-1"
            >
      ...
      <div>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {mockCredentials.slice(1).map((credential) => {
