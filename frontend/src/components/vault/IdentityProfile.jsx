...
import { mockStudentDID } from "../../data/mockData";
          ...
          <div className="space-y-3">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-sm bg-secondary/50 px-3 py-2 rounded border">{mockStudentDID.name}</p>
              </div>
              <div>
                <p className="text-xs text-muted-foreground mb-1">DID Identifier</p>
                <p className="text-sm bg-secondary/50 px-3 py-2 rounded border font-mono">{mockStudentDID.id}</p>
              </div>
            </div>
          </div>
