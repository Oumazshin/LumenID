            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-sm font-mono bg-background px-3 py-2 rounded border">
                  {mockInstitutionDID.id}
                </p>
              </div>
              <div>
                <p className="text-xs text-muted-foreground mb-1">Public Key</p>
                <p className="text-sm font-mono bg-background px-3 py-2 rounded border">
                  {mockInstitutionDID.publicKey}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  id="institutionName"
                  defaultValue={mockInstitutionDID.name}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  id="website"
                  defaultValue={mockInstitutionDID.website}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  id="location"
                  defaultValue={mockInstitutionDID.location}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  id="regNumber"
                  defaultValue={mockInstitutionDID.registrationNumber}
                />
              </div>
            </div>
          </div>
            ...
            <div className="space-y-3">
              <div>
                ...
                <div className="bg-secondary/50 border rounded px-3 py-2">
                  <p className="text-sm font-mono">{mockInstitutionDID.publicKey}</p>
                </div>
              ...
              <div>
                ...
                <div className="bg-secondary/50 border rounded px-3 py-2">
                  <p className="text-sm">{mockInstitutionDID.blockchain}</p>
                </div>
              </div>
            </div>
          </div>
