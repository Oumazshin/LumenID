...
import { CheckCircle2, Loader2, Upload, FileText, X, Award, Plus, Trash2, BookOpen, Code } from "lucide-react";
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="studentEmail" className="text-sm font-medium">
                  Student Email (for Offer notification)
                </Label>
                <Input
                  id="studentEmail"
                  type="email"
